...
imageBlanche.ecrireFichierRaw(ImageRaw + "ImageBlanche.raw");
...
output.sauvegarderPGM(imagePGM + "image_filtrée_gaussien.pgm");
outputImage.sauvegarderPGM(imagePGM + "image_filtrée_moyeneur.pgm");
outputImage2.sauvegarderPGM(imagePGM + "image_filtrée_expo.pgm");
